...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ajax: baseUrl + 'admin/users', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              ...
              Researcher: '<i class="ti ti-chart-pie ti-md text-info me-2"></i>',
              Superadmin: '<i class="ti ti-device-desktop ti-md text-danger me-2"></i>'
            };
            return (
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var statusInfo = statusObj[$status] || statusObj[3]; // Fallback to inactive if status invalid
