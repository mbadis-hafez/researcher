...
<div class="row">
  <div class="col-12">
    <div class="card card-body">
        ...
        <p>{{ trans('2') }}. {{trans('you can download the example file to understand how the data must be filled.')}}</p>

        <p>{{ trans('3') }}. {{trans('once you have downloaded and filled the format file')}}, {{trans('upload it in the form below and submit.')}}</p>
  ...
  <div class="col-md-12 mt-2">
    <form  action="{{ route('app-artist-store-by-bulk') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card rest-part">
          <div class="px-3 py-4 d-flex flex-wrap align-items-center gap-10 justify-content-center">
              ...
              <a href="{{asset('public/assets/template/artist_bulk_import_template.csv')}}" download=""
          ...
          <div class="card-body">
            ...
            <div class="form-group">
                <div class="row justify-content-center">
                    <div class="col-auto">
                      <div class="uploadDnD">
                        <div class="form-group inputDnD input_image input_image_edit" data-title="{{trans('drag & drop file or browse file')}}">
                          <input type="file" name="artists_file" accept=".xlsx, .xls" class="form-control-file text--primary font-weight-bold action-upload-section-dot-area" id="inputFile">
                        </div>
                      </div>
                    </div>
                </div>
